...
<nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 my-3 {{ (Request::is('static-sign-up') ? 'w-100 shadow-none  navbar-transparent mt-4' : 'blur blur-rounded shadow py-2 start-0 end-0 mx4') }}">
  ...
  <img src="https://poliwangi.ac.id/wp-content/uploads/2021/02/logo-poliwangi.png" class="navbar-brand-img h-100 ml-1" width="45px" alt="...">
    <a class="navbar-brand font-weight-bolder ms-3{{ (Request::is('static-sign-up') ? 'text-white' : '') }}" href="{{ url('dashboard') }}">
     Perpustakaan 
     <p class="mb-0">Politeknik Negeri Banyuwangi<br></p>
    </a>
